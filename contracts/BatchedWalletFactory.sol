...
contract BatchedWalletFactory {
    ...
    BatchedWallet public immutable accountImplementation;

    constructor(IEntryPoint _entryPoint) {
        accountImplementation = new BatchedWallet(_entryPoint);
    }
    ...
    function returnAddress(address owner,uint256 salt) public view returns (address) {
